...
We present a formal representation model of an IT system, named  MACM (Multi-purpose Application Composition Model). It is represented as a property graph model, including syntactic and semantic constraints. 
